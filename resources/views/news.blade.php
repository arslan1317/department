        ...
        @if(count($last_7_days) != 0)
            ...
            @foreach($last_7_days as $news)
                <div class="row">
                        ...
                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="{{url('/news/main-department')}}/{{$news->id}}">View All {{$all_departments->name}} News</a>
                        </div>
                    </div>
                @endforeach
        @endif
            ...
            @if(count($all_departments->news) != 0)
                ...
                @foreach($all_departments->news as $news)
                    <div class="row">
                            ...
                            <div class="col-12 text-center mb-30">
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="#">View All {{$all_departments->name}} News</a>
                            </div>
                        </div>
                @endforeach
            @endif
                ...
                @if(count($subdepartments->news) != 0)
                    ...
                    @foreach($subdepartments->news as $news)
                        <div class="row">
                            ...
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="{{url('/news/department')}}/{{$news->id}}">View All {{$news->subdepartment->name}} News</a>
                            </div>
                        </div>
