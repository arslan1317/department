				...
				<div class="col-md-8">
					<div class="card" data-height="">
						...
						<div class="card-content collapse show" style="">
							<div class="card-body">
								<form class="form" method="post" action="{{route('aboutus.admin.update', $about->id)}}" enctype="multipart/form-data">
									@csrf
									<input type="hidden" value="{{$about->section_type}}" name="section_type">
									<div class="form-body">
										<div class="row">
                                            <div class="col-md-12">
												<div class="form-group">
                                                    ...
                                                    @if($about->banner_image != null)
                                                        <img src="{{asset('images')}}/{{$about->banner_image}}" alt="" class="w-100">
                                                    @endif
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Details</label>
													<textarea name="details" id="summernote-code" class="summernote-code">{!! $about->details !!}</textarea>
												</div>
											</div>
										</div>
